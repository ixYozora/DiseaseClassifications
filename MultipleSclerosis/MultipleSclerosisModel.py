...
class MultipleSclerosisModel(nn.Module):
    def __init__(self, input_size=11, hidden_size=399, output_size=1):
        super(MultipleSclerosisModel, self).__init__()
...
class MultipleSclerosisPredictor:
    def __init__(self, model_path):
        self.model = MultipleSclerosisModel()
