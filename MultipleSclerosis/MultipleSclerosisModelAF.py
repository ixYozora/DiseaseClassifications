...
class MultipleSclerosisModelAF(nn.Module):
    def __init__(self, input_size=16, hidden_size=202, output_size=1):
        super(MultipleSclerosisModelAF, self).__init__()
...
class MultipleSclerosisPredictorAF:
    def __init__(self, model_path):
        self.model = MultipleSclerosisModelAF()
