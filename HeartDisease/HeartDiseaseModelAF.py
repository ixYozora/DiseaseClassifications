...
class HeartDiseaseModelAF(nn.Module):
    def __init__(self, input_size=11, hidden_size=92, output_size=1):
        super(HeartDiseaseModelAF, self).__init__()
        self.norm0 = NormFunction1D(input_size)
        self.fc1 = nn.Linear(input_size, hidden_size)
        self.relu = nn.ReLU()

        self.norm1 = NormFunction1D(hidden_size)
...
class HeartDiseasePredictorAF:
    def __init__(self, model_path):
        self.model = HeartDiseaseModelAF()
