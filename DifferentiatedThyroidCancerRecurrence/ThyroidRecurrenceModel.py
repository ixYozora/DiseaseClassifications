...
class ThyroidRecurrenceModel(nn.Module):
    def __init__(self, input_size=8, hidden_size=24):
        super(ThyroidRecurrenceModel, self).__init__()
...
class ThyroidRecurrencePredictor:
    def __init__(self, model_path):
        self.model = ThyroidRecurrenceModel()
