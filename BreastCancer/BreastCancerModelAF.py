...
class BreastCancerModelAF(nn.Module):
    def __init__(self, input_size=8, hidden_size=71):
        super(BreastCancerModelAF, self).__init__()
...
class BreastCancerPredictorAF:
    def __init__(self, model_path):
        self.model = BreastCancerModelAF()
